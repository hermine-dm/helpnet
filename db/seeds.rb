...
10.times do 
	...
	@user = User.create!(email: "#{@fist_name}#{rand(0..15)}@yopmail.com",  password: "password", password_confirmation: "password", created_at: Faker::Date.between(from: 15.days.ago, to: Date.today), last_sign_in_at: Faker::Date.between(from: 15.days.ago, to: Date.today))
end
puts "users créés"
