...
ActiveRecord::Schema.define(version: 20_191_212_164_255) do
  ...
  create_table 'thredded_messageboard_notifications_for_followed_topics', force: :cascade do |t|
    ...
    t.index %w[user_id messageboard_id notifier_key], name: 'thredded_messageboard_notifications_for_followed_topics_unique', unique: true
  end
  ...
  create_table 'thredded_messageboard_users', force: :cascade do |t|
    ...
    t.index %w[thredded_messageboard_id thredded_user_detail_id], name: 'index_thredded_messageboard_users_primary', unique: true
  end
  ...
  create_table 'thredded_post_moderation_records', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.index %w[messageboard_id created_at], name: 'index_thredded_moderation_records_for_display', order: { created_at: :desc }
  end
  ...
  create_table 'thredded_topics', force: :cascade do |t|
    ...
    t.index %w[moderation_state sticky updated_at], name: 'index_thredded_topics_for_display', order: { sticky: :desc, updated_at: :desc }
  ...
  create_table 'thredded_user_details', force: :cascade do |t|
    ...
    t.index %w[moderation_state moderation_state_changed_at], name: 'index_thredded_user_details_for_moderations', order: { moderation_state_changed_at: :desc }
  ...
  create_table 'thredded_user_messageboard_preferences', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[user_id messageboard_id], name: 'thredded_user_messageboard_preferences_user_id_messageboard_id', unique: true
  end
