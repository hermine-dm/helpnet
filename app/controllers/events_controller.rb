...
class EventsController < ApplicationController
  ...
  before_action :authenticate_user_event_or_admin, only: %i[new create edit update]
  ...
  def post_params
    params.require(:event).permit(:start_date, :end_date, :title, :description, :illustration, address_attributes: %i[number street additionnal_information zip_code city])
  end
